...
const FEATURE_GROUPS: readonly FeatureGroup[] = [
  { id: "academies", icon: Building2, items: ["overview", "provisioning", "branding"] },
  { id: "lms", icon: BookOpen, items: ["courses", "quizzes", "assignments"] },
  { id: "people", icon: Users, items: ["students", "enrollment", "progress"] },
  { id: "instructors", icon: GraduationCap, items: ["teaching", "grading", "scoped"] },
  { id: "website", icon: Palette, items: ["builder", "themes", "cms"] },
  { id: "domains", icon: Globe2, items: ["subdomains", "customDomains", "ssl"] },
  { id: "organizations", icon: Network, items: ["multiAcademy", "roles", "billing"] },
  { id: "analytics", icon: BarChart3, items: ["dashboards", "reporting"] },
  { id: "security", icon: ShieldCheck, items: ["isolation", "auditLog", "infrastructure"] },
];
